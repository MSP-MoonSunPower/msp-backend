...
function SignUp() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setShowModal(true); // 개인정보 동의 모달 띄우기
  };
        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalBody}>
              <p>
                본 서비스(이하 : MoonSunPower)는 귀하의 개인정보를 보호하고
                안전하게 관리하기 위해 최선을 다하고 있습니다. 본 동의서는
                MoonSunPower에서 제공하는 서비스를 이용하기 위해 필요한
                개인정보의 수집 및 이용에 동의함을 확인힙니다.
              </p>
              <p>
                <strong>제 1조 [목적]</strong> <br />본 동의서는 MoonSunPower
                제반 서비스의 회원 관리, 구독 서비스 제공, 서비스 개발 및 개선의
                목적으로만 개인정보를 이용합니다. <br />- 회원 가입 의사의 확인,
                연령 확인 및 법정대리인 동의 진행, 이용자 및 법정대리인의 본인
                확인, 이용자 식별, 회원탈퇴 의사의 확인 등 회원관리를 위하여
                개인정보를 이용합니다. <br />- 컨텐츠 등 기존 서비스 제공(광고
                포함), 서비스 이용기록과 접속 빈도 분석, 서비스 이용에 대한
                통계, 서비스 분석 및 통계에 따른 맞춤 서비스 제공 및 광고 게재
                등에 개인정보를 이용합니다. <br />- 컨텐츠 생성·제공 등에서의
                인공지능(AI) 기술 적용이 포함됩니다. <br />- 유료 서비스 제공에
                따르는 본인인증, 구매 및 요금 결제, 상품 및 서비스의 배송을
                위하여 개인정보를 이용합니다. <br />- 이벤트 정보 및 참여기회
                제공, 광고성 정보 제공 등 마케팅 및 프로모션 목적으로 개인정보를
                이용합니다.
                <br />
                <br /> <strong>제 2조 [수집정보 내역]</strong> <br />
                이용자는 회원가입을 하지 않아도 오늘의 지문, 초중고급 문제풀이와
                같은 핵심 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가
                오답노트, 친구맺기와 같이 개인화 혹은 회원제 서비스를 이용하기
                위해 회원가입을 할 경우, 네이버는 서비스 이용을 위해 필요한
                최소한의 개인정보를 수집합니다. <br />
                <br />
                회원가입 시점에 MoonSunPower가 이용장로부터 수집하는 개인정보는
                아래와 같습니다. <br />- 회원 가입 시 필수항목으로 아이디,
                비밀번호, 이름과 성별을, 선택항목으로 생년월일을 수집합니다.
                <br />
                <br /> <strong>제 3조 [보유 및 이용 기간] </strong>
                <br />
                MoonSunPower는 원칙적으로 이용자의 개인정보를 회원 탈퇴 시
                지체없이 파기하고 있습니다. 전자상거래 등에서의 소비자 보호에
                관한 법률, 전자문서 및 전자거래 기본법, 통신비밀보호법 등
                법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다.
                MoonSunPower는 이 기간 동안 법령의 규정에 따라 개인정보를
                ...
                수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는
