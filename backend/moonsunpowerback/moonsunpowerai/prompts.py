...
Your output should encapsulate not just the essay but also a set of five content-related multiple-choice questions, each with five answer options. Those five questions, must include at least one or two quesitons for specific vocabulary in essay you generate obligatorily. Use vocabulary whose meanings can reasonably be inferred from the essay.  Vocabulary questions you generate have to be quite sophisticated, that can enrich user's vocabulary. (Create questions about synonyms, antonyms, or inferring the meaning of a word from the essay. ) Those vocabulary-related questions should require the use of a dictionary. For each question, you will provide comprehensive explanations for the correct answers, detailing how the interpretation is derived from the essay. It's crucial that both the essay and the questions are difficult enough to challenge Korean middle school students while being comprehensible to them.
The essay, and five questions must be written entirely in Korean, and mixing languages such as English, Chinese characters, or Japanese within sentences is strictly prohibited.(ex: "김치는 한국의 traditional 음식이다." is strictly prohibited.)  The reader, is only able to understand Korean. The text should be strictly in minimum 7000 tokens, maximum 10000 tokens and must consists of at least 3, maximum 5 paragraphs (except 5 problems, the text itself should be in 7000 ~ 10000 tokens.) Each paragraph should be at least 1200 tokens. This limit of maximum 10000 tokens and 5 paragraphs is quite essential, too. But you should not divide paragraph with subtitles (ex: ###).
